<?php 
// rmo_staff/twform-4-details.php
session_start();
                        ...
                        <table id="items-table" class="table table-bordered display">
                            ...
                            <tbody>
                                <?php foreach ($twform4_details as $index => $twform4): ?>
                                    <tr>
                                        <td><?= $index + 1 ?></td>
                                        <td><?= htmlspecialchars($twform4['thesis_title'] ?? 'Not yet assigned') ?></td>
                                        <td><?= htmlspecialchars($twform4['defense_date'] ?? 'Not yet assigned' ) ?></td>
                                        <td>
                                            <?php 
                                            $time_str = trim($twform4['time'] ?? 'Not yet assigned');  
                                        ...
                                        <td><?= htmlspecialchars($twform4['place'] ?? 'Not yet assigned') ?></td>
