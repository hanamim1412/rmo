...
<section id="twform-1-details" class="pt-4">
    <div class="header-container pt-4">
        <h4 class="text-left">
            TW form 2: Approval of Proposal Hearing
        </h4>
    </div>
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="details-section">
            ...
            <div class="table-container mt-4">
                <form action="tw2_update_defense_schedule.php" method="POST">
                    ...
                    <input type="hidden" name="form_type" value="<?= htmlspecialchars($twform_details['form_type'] ?? ''); ?>">
                        ...
                        <table id="items-table" class="table table-bordered display">
                            ...
                            <tbody>
                                    <?php $i = 1; foreach ($twform2_details as $twform2): ?>
                                    <tr>
                                        <td><?= $i++; ?></td>
                                        <td><?= htmlspecialchars($twform2['thesis_title']) ?></td>
                                        <td>
                                            <input type="date" name="defense_date" value="<?= htmlspecialchars($twform2['defense_date'] ?? ''); ?>" class="form-control form-control-sm" required>
                                        </td>

                                        <td>
                                            <input type="time" name="time" value="<?= htmlspecialchars($twform2['time'] ?? ''); ?>" class="form-control form-control-sm" required>
                                        </td>

                                        <td>
                                            <textarea name="place" class="form-control form-control-sm w-auto" rows="2" required><?= htmlspecialchars($twform2['place'] ?? 'Enter Venue'); ?></textarea>
                                        </td>
                                        <td><?= htmlspecialchars($twform2['last_updated']) ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
