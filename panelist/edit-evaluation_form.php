<?php 
// panelist/edit-evaluation_form.php
session_start();
...
<section id="assign-panelists-form">
    <div class="header-container">
        <h4 class="text-left">Edit Evaluation Form</h4>
    </div>
    ...
    <div class="container">
        <div class="register-box" id="view">
            <form action="submit_evaluation.php" method="POST" class="form-control">
                ...
                <input type="hidden" name="eval_id" value="<?= htmlspecialchars($eval_criteria['eval_id']) ?>">
                ...
                <table id="items-table" class="table table-bordered display">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="number" name="presentation" class="form-control" style="border: 1px solid rgb(10, 62, 140); padding: 5px 10px;" max="15" min="0" value="<?= htmlspecialchars($eval_criteria['presentation']) ?>" required></td>
                        </tr>
                        <tr>
                            <td>Content (25 pts.)</td>
                            <td><input type="number" name="content" class="form-control" style="border: 1px solid rgb(10, 62, 140); padding: 5px 10px;" max="25" min="0" value="<?= htmlspecialchars($eval_criteria['content']) ?>" required></td>
                        </tr>
                        <tr>
                            <td>Organization (10 pts.)</td>
                            <td><input type="number" name="organization" class="form-control" style="border: 1px solid rgb(10, 62, 140); padding: 5px 10px;" max="10" min="0" value="<?= htmlspecialchars($eval_criteria['organization']) ?>" required></td>
                        </tr>
                        <tr>
                            <td colspan="2">Mastery of the Subject Matter (20 pts.)</td>
                            <td><input type="number" name="mastery" class="form-control" style="border: 1px solid rgb(10, 62, 140); padding: 5px 10px;" max="20" min="0" value="<?= htmlspecialchars($eval_criteria['mastery']) ?>" required></td>
                        </tr>
                        <tr>
                            <td colspan="2">Ability to Respond to Questions (20 pts.)</td>
                            <td><input type="number" name="ability" class="form-control" style="border: 1px solid rgb(10, 62, 140); padding: 5px 10px;" max="20" min="0" value="<?= htmlspecialchars($eval_criteria['ability']) ?>" required></td>
                        </tr>
                        <tr>
                            <td colspan="2">Openness Towards the Given Suggestions (10 pts.)</td>
                            <td><input type="number" name="openness" class="form-control" style="border: 1px solid rgb(10, 62, 140); padding: 5px 10px;" max="10" min="0" value="<?= htmlspecialchars($eval_criteria['openness']) ?>" required></td>
                        </tr>
                        <tr>
                            <td colspan="2" class="font-weight-bold">Overall Rating (Sum of Scores)</td>
                            <td>
                                <input type="number" name="overall_rating" class="form-control" style="border: 1px solid rgb(10, 62, 140); padding: 5px 10px;" readonly value="<?= htmlspecialchars($eval_criteria['overall_rating']) ?>">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="font-weight-bold">Percentage</td>
                            <td>
                                <input type="text" name="percentage" class="form-control" style="border: 1px solid rgb(10, 62, 140); padding: 5px 10px;" readonly value="<?= htmlspecialchars($eval_criteria['percentage']) ?>">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="font-weight-bold">Remarks</td>
                            <td>
                                <textarea name="remarks" class="form-control" style="border: 1px solid rgb(10, 62, 140); padding: 5px 10px;" rows="3" maxlength="500"><?= htmlspecialchars($eval_criteria['remarks']) ?></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-success">Update Evaluation</button>
                </div>
            </form>
        </div>
    </div>
