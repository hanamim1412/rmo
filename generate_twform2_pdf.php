...
$pdf->SetTitle('TW Form 2 Details');
...
$html .= '<tr><td><strong>TW Form Type:</strong></td><td>TW Form 2: Approval of Proposal Hearing</td></tr>';

foreach ($twform2_details as $twform2) {
    ...
    $html .= '<tr><td><strong>Thesis Title:</strong></td><td>' . htmlspecialchars($twform2['thesis_title']) . '</td></tr>';
    $html .= '<tr><td><strong>Defense Date:</strong></td><td>';
        $defense_date = DateTime::createFromFormat('Y-m-d', $twform2['defense_date']);
        if ($defense_date) {
        ...
        $html .= '</td></tr>';
    $formatted_time = DateTime::createFromFormat('H:i:s', $twform2['time']);
    if ($formatted_time) {
    ...
    $html .= '<tr><td><strong>Venue:</strong></td><td>' . htmlspecialchars($twform2['place']) . '</td></tr>';
}
