    ...
    <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4 shadow" style="width: 500px;">
            <div class="register-box">
                <form action="submit-department.php" method="post" class="form-container p-2" enctype="multipart/form-data">
                ...
                <?php endif; ?>
                    ...
                    <div class="form-group">
                        <label for="file">Attach Logo Image:</label>
                        <input type="file" class="form-control mt-1" name="logo" required>
                    </div>
