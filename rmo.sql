...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2025 at 12:31 PM
...
(18, 'C24-0010', '$2y$10$MpLt0WhdBU1ViYAA0amsOOQ1Ie44jPNpD5GkjsHG6gGbIUd83X8r6', 'Marites Fe', 'Monsanto', '098765432128', 1, 'maritesfe.monsanto@my.smciligan.edu.ph', 'subject_advisor', '2024-12-30 23:08:45'),
(19, 'C24-0011', '$2y$10$hr.XiOg0JZ9Kmm0jwhDh5.AsGB4cdP7uANl.y/loikr8PWefCz5T6', 'Marites Fe', 'Monsanto', '09876543219', 1, 'maritesfe.monsanto@my.smciligan.edu.ph', 'panelist', '2024-12-30 23:10:01');
...
(21, 'twform_3', 1, 4, 1, 1, 9, 13, 'approved', NULL, '2024-12-30', '2024-12-30 15:28:37'),
...
--
ALTER TABLE `assigned_panelists`
  MODIFY `assigned_panelist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `proponents`
  MODIFY `proponent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `proposed_title`
--
ALTER TABLE `proposed_title`
  MODIFY `proposed_title_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `twform_1`
  MODIFY `form1_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `twform_2`
--
ALTER TABLE `twform_2`
  MODIFY `form2_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tw_forms`
  MODIFY `tw_form_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
