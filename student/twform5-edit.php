...
ob_start();
$title = "TW Form 5: Rating for Final";
...
function getFormData($tw_form_id) {
    ...
    $query = "
        ...
        JOIN twform_5 AS form5 ON twforms.tw_form_id = form5.tw_form_id 
...
<section id="request-form">
        <div class="header-container">
            <h4 class="text-left">Edit Tw Form 5</h4>
        </div>
    ...
    <div class="container">
        <form id="twform5" method="POST" action="submit-edit-tw5.php" enctype="multipart/form-data" class="form-container">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="date" name="defense_date" class="form-control" value="<?= htmlspecialchars($form_data['defense_date']) ?>" required>
                </div>
                <div class="form-group col-md-4">
                    <label>Defense Time</label>
                    <input type="time" name="defense_time" class="form-control" value="<?= htmlspecialchars($form_data['time']) ?>"  required>
                </div>
                <div class="form-group col-md-4">
                    <label>Defense Place</label>
                    <input type="text" name="defense_place" class="form-control" value="<?= htmlspecialchars($form_data['place']) ?>" placeholder="Enter place" required>
                </div>
            </div>
