...
<section id="request-form">
        <div class="header-container">
            <h4 class="text-left">Tw Form 6</h4>
        </div>
    ...
    <div class="container">
        <form id="twform6" method="POST" action="submit-twform6.php" enctype="multipart/form-data" class="form-container">
            ...
            <h2>TW Form 6: Approval for Binding</h2>
    ...
    adviserInput.addEventListener('input', function() {
        ...
        document.getElementById('reset-button').addEventListener('click', () => {
            if (confirm('Are you sure you want to reset the form?')) {
                document.getElementById('twform6').reset();
                proponentsContainer.innerHTML = `
                <label>Proponents details</label>
                <div class="form-row mt-2 align-items-center">
                    <div class="form-group col-md-6">
                        <input type="text" name="student_firstnames[]" class="form-control mb-1 proponent" placeholder="Enter firstname">
                    </div>
                    <div class="form-group col-md-6">
                        <input type="text" name="student_lastnames[]" class="form-control mb-1 proponent" placeholder="Enter lastname">
                    </div>
                </div>
                <div class="form-group col-md-2">
                <button type="button" class="btn btn-success btn-sm add-proponent m-1"><i class="fas fa-plus"></i></button>
