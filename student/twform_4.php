...
<section id="request-form">
    ...
    <div class="container">
        <form id="twform4" method="POST" action="submit-twform4.php" enctype="multipart/form-data" class="form-container">
            ...
            <h2>TW Form 4: Approval for Oral Examination/Final Defense</h2>
